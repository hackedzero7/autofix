    ...
    return (
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute bottom-3 right-3 h-14 w-14 animate-ping rounded-full bg-green-500/30"></div>
          <div
            className="absolute bottom-20 right-3 h-14 w-14 animate-ping rounded-full bg-red-500/30"
